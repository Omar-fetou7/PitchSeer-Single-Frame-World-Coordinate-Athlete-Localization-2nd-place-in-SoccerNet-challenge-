...
class TopDown(BasePose):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 loss_pose=None,
                 loss_3d_keypoint=None,
                 lambda_3d=0.001):
        super().__init__()
        self.fp16_enabled = False

        self.loss_3d = (builder.build_loss(loss_3d_keypoint)
                        if loss_3d_keypoint is not None else None)
    ...
    def forward_train(self, img, target, target_weight, img_metas, **kwargs):
        ...
        if self.loss_3d is not None and self.with_keypoint:
            losses['loss_3d'] = self.lambda_3d * self.loss_3d(output, img_metas)
