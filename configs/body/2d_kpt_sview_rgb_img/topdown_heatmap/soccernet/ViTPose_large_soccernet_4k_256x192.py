...
# Layer-wise learning rate decay: early backbone layers get a much smaller lr
# than the new head, preventing the pretrained features from being destroyed.
optimizer = dict(
    type='AdamW',
    lr=4e-4,
    betas=(0.9, 0.999),
...
# Load pretrained ViTPose++ Large backbone (COCO split).
# The 17-keypoint head weights are mismatched and will be ignored —
# only the backbone loads. The 2-keypoint head initialises from scratch.
