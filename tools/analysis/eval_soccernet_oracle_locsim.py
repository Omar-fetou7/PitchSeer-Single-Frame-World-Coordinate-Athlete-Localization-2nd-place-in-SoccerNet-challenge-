...
sys.path.insert(0, str(_Path(__file__).resolve().parents[2]))  # pose-workspace-private/ViTPose
...
def parse_args():
    ...
    parser.add_argument(
        '--output-dir',
        default='evaluation/oracle_detection',
        help='Directory for predictions, metrics, and markdown summary (relative to repo root).')
    parser.add_argument(
